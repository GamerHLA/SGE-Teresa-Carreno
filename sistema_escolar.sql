...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-01-2026 a las 04:14:55
...
CREATE TABLE `alumnos` (
  ...
  `id_nacionalidades` int(11) DEFAULT NULL,
  ...
  `actividad_extra` varchar(100) DEFAULT NULL,
...
INSERT INTO `alumnos` (`alumno_id`, `id_nacionalidades`, `cedula`, `nombre`, `apellido`, `fecha_nac`, `sexo`, `edad`, `id_estado`, `id_ciudad`, `id_municipio`, `id_parroquia`, `estatus`, `actividad_extra`, `talla_camisa`, `talla_pantalon`) VALUES
(1, 3, '31637673', 'Alexander Daniel', 'Castillo Goncalves', '2020-12-16', 'M', 5, 24, 149, 462, 1137, 1, 'Realiza Natacion los sabados y viernes en la tarde', '8', '8'),
(2, 1, '16816459547', 'Baby Luigi', 'Brother', '2016-05-17', 'M', 9, 14, 269, 228, 618, 1, 'mata dragones tortugas', 'S', 'S'),
(3, 2, '5645253', 'Luisa', 'Marin', '2018-08-08', 'F', 7, 5, 76, 64, 201, 1, 'Baila Salsa los dias lunes y martes en la noche', '12', '10'),
(4, 3, '56987542', 'Link', 'in Park', '2010-07-04', 'M', 15, 12, 212, 144, 459, 2, 'nada', '8', '10'),
(5, 3, '32665987', 'Juanito', 'Perez', '2015-05-16', 'M', 10, 5, 84, 64, 204, 1, 'Practica futbol', 'M', 'M'),
(6, 3, '33645321', 'Kiko', 'Chespirito', '2016-07-16', 'M', 9, 24, 149, 462, 1127, 1, 'Juega futbol los dias lunes en la tarde', 'M', 'M'),
(7, 1, '83645123', 'Carelis', 'Mendoza', '2019-09-09', 'F', 6, 8, 139, 99, 308, 1, NULL, NULL, NULL),
(8, 3, '33666201', 'Willian', 'Afton', '2020-12-17', 'M', 5, 6, 89, 68, 226, 1, NULL, NULL, NULL),
(9, 3, '12215688214', 'Elpan', 'Zon', '2022-01-05', 'M', 4, 14, 278, 240, 645, 1, NULL, NULL, NULL),
(10, 3, '33637673', 'Rigoberto', 'Mariscal', '2016-11-16', 'M', 9, 24, 149, 462, 1124, 2, NULL, NULL, NULL),
(11, 3, '12121656984', 'Kalee', 'Rodriguez', '2021-05-04', 'M', 4, 24, 149, 462, 1120, 1, 'Practica futbol americano', 'M', '14');

--
-- Disparadores `alumnos`
--
DELIMITER $$
CREATE TRIGGER `actualizar_edad_alumno` BEFORE INSERT ON `alumnos` FOR EACH ROW BEGIN
    IF NEW.fecha_nac IS NOT NULL THEN
        SET NEW.edad = YEAR(CURDATE()) - YEAR(NEW.fecha_nac) - 
            (DATE_FORMAT(CURDATE(), '%m%d') < DATE_FORMAT(NEW.fecha_nac, '%m%d'));
    END IF;
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `actualizar_edad_alumno_update` BEFORE UPDATE ON `alumnos` FOR EACH ROW BEGIN
    IF NEW.fecha_nac IS NOT NULL THEN
        SET NEW.edad = YEAR(CURDATE()) - YEAR(NEW.fecha_nac) - 
            (DATE_FORMAT(CURDATE(), '%m%d') < DATE_FORMAT(NEW.fecha_nac, '%m%d'));
    END IF;
...
--
-- Estructura de tabla para la tabla `alumnos_atencion_medica`
--

CREATE TABLE `alumnos_atencion_medica` (
  `id` int(11) NOT NULL,
  `alumno_id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `alumnos_atencion_medica`
--

INSERT INTO `alumnos_atencion_medica` (`id`, `alumno_id`, `tipo_atencion`, `nombre_doctor`, `telefono`) VALUES
(11, 1, 'Médico', 'Alejandro', '02125412844');
...
INSERT INTO `alumno_representante` (`relacion_id`, `alumno_id`, `representante_id`, `parentesco_id`, `es_principal`, `estatus`) VALUES
(24, 24, 15, NULL, 1, 1),
(25, 1, 2, 6, 0, 1),
(26, 2, 3, 4, 1, 1),
(27, 3, 1, NULL, 0, 1),
...
--
-- Estructura de tabla para la tabla `alumno_vacunas`
--

CREATE TABLE `alumno_vacunas` (
  `id_alumno_vacuna` bigint(20) UNSIGNED NOT NULL,
  `alumno_id` int(11) NOT NULL,
  `vacuna_id` bigint(20) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `alumno_vacunas`
--

INSERT INTO `alumno_vacunas` (`id_alumno_vacuna`, `alumno_id`, `vacuna_id`) VALUES
(18, 1, 11),
(17, 1, 12),
(20, 11, 2),
(19, 11, 6),
...
CREATE TABLE `curso` (
  ...
  `grados_id` bigint(20) UNSIGNED DEFAULT NULL,
...
INSERT INTO `curso` (`curso_id`, `grados_id`, `seccion_id`, `cupo`, `turno_id`, `periodo_id`, `profesor_id`, `estatusC`) VALUES
(1, 1, 1, 4, 1, 31, 3, 2),
(2, 1, 2, 3, 1, 31, 10, 2),
(3, 1, 3, 4, 2, 31, 8, 2),
(4, 1, 4, 12, 2, 31, 11, 2),
...
INSERT INTO `discapacidad` (`id_discapacidad`, `discapacidad`, `activo`) VALUES
(1, 'Parálisis cerebral', 1),
(2, 'Espina bífida', 1),
(3, 'Distrofia muscular', 1),
(4, 'Amputación congénita', 1),
(5, 'Sordera total', 1),
(6, 'Hipoacusia severa', 1),
(7, 'Ceguera total', 1),
(8, 'Baja visión', 1),
(9, 'Sordoceguera', 0),
(10, 'Discapacidad intelectual leve', 1),
(11, 'Discapacidad intelectual moderada', 1),
(12, 'Síndrome de Down', 1),
(13, 'Autismo (TEA)', 1),
(14, 'TDAH severo', 1),
(15, 'Síndrome de Asperger', 1),
(16, 'Discapacidad múltiple', 1),
(18, 'Amaste', 0),
(19, 'A', 0);
...
CREATE TABLE `enfermedad` (
  `id_enfermedad_cronica` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `enfermedad` (`id_enfermedad_cronica`, `enfermedades`, `observaciones`, `activo`) VALUES
(1, 'Asma', NULL, 1),
(2, 'Diabetes', NULL, 1),
(3, 'Epilepsia', NULL, 1),
(4, 'Hipertensión', NULL, 1),
(5, 'Alergias', NULL, 0),
(6, 'Cardiopatías', NULL, 1),
(7, 'Trastornos de la tiroides', NULL, 1),
(8, 'Enfermedad renal crónica', NULL, 1),
(9, 'Cáncer', NULL, 1),
(10, 'Enfermedades autoinmunes', NULL, 1),
(11, 'Alergias alimentarias', NULL, 1),
(13, 'Conjuntivitis infecciosa', NULL, 1),
(14, 'COVID-19', NULL, 1),
(15, 'Dermatitis atópica', NULL, 1),
(16, 'Diabetes tipo 1', NULL, 1),
(18, 'Escabiosis', NULL, 1),
(19, 'Faringitis estreptocócica', NULL, 1),
(20, 'Gastroenteritis viral', NULL, 1),
(21, 'Gripe (Influenza)', NULL, 1),
(22, 'Impétigo', NULL, 1),
(23, 'Infección urinaria', NULL, 1),
(24, 'Molusco contagioso', NULL, 1),
(25, 'Neumonía', NULL, 1),
(26, 'Otitis media', NULL, 1),
(27, 'Paperas (Parotiditis)', NULL, 1),
(28, 'Piojos (Pediculosis)', NULL, 1),
(29, 'Rinitis alérgica', NULL, 1),
(30, 'Rubeola', NULL, 1),
(31, 'Sarampión', NULL, 1),
(32, 'Sarna (Escabiosis)', NULL, 1),
(33, 'Sinusitis', NULL, 1),
(34, 'Tosferina', NULL, 1),
(35, 'Varicela', NULL, 1),
(36, 'pipi', NULL, 0),
...
--
-- Estructura de tabla para la tabla `especialidades_estudio`
--

CREATE TABLE `especialidades_estudio` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `especialidades_estudio`
--

INSERT INTO `especialidades_estudio` (`id`, `nivel_id`, `nombre`, `orden`, `estatus`) VALUES
(1, 1, 'Educación Básica (Primaria)', 1, 1),
(2, 2, 'Artes', 2, 1),
(3, 2, 'Ciencias', 3, 1),
(4, 2, 'Humanidades', 4, 1),
(5, 3, 'Administración', 5, 0),
(6, 3, 'Agropecuaria', 6, 1),
(7, 3, 'Contabilidad', 7, 1),
(8, 3, 'Electricidad', 8, 1),
(9, 3, 'Informática', 9, 1),
(10, 3, 'Mecánica', 10, 1),
(11, 3, 'Salud (Enfermería)', 11, 0),
(12, 3, 'Salud (Registros Médicos)', 12, 1),
(13, 3, 'Turismo', 13, 1),
(67, 4, 'General / Sin Especialidad', 1, 1),
(68, 5, 'General / Sin Especialidad', 1, 1),
(69, 6, 'General / Sin Especialidad', 1, 1),
(70, 7, 'General / Sin Especialidad', 1, 1),
(72, 1, 'Zoolander', 2, 1),
(74, 1, 'Homunculo', 4, 1),
(75, 1, 'Ñame', 5, 0),
(76, 3, 'A', 14, 0),
(77, 1, 'FLSMDFR', 6, 0),
(78, 1, 'QQER', 7, 0),
(79, 8, '__DEFAULT__', 1, 1),
(80, 8, 'aa', 2, 0),
(81, 8, 'bb', 3, 0),
(82, 8, 'cc', 4, 0),
(83, 9, '__DEFAULT__', 1, 1),
(84, 9, '1', 2, 0),
(85, 6, 'Administracion', 2, 1);
...
INSERT INTO `grados` (`id_grado`, `grado`, `estatus`) VALUES
(1, 1, 1),
(2, 2, 1),
(3, 3, 1),
(4, 4, 1),
...
CREATE TABLE `grupo_sanguineo` (
  `id_grupo_sanguineo` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `grupo_sanguineo` (`id_grupo_sanguineo`, `grupo_sanguineo`, `activo`) VALUES
(1, 'A+', 1),
(2, 'A-', 1),
(3, 'B+', 1),
(4, 'B-', 1),
...
CREATE TABLE `informacion_medica` (
  ...
  `enfermedad_id` bigint(20) UNSIGNED DEFAULT NULL,
  `discapacidad_id` bigint(20) UNSIGNED DEFAULT NULL,
  `diagnostico` varchar(200) DEFAULT NULL,
  `fecha_diagnostico` date DEFAULT NULL,
  `tratamiento` text DEFAULT NULL,
  `restricciones` text DEFAULT NULL COMMENT 'Ej: No hacer educación física',
  `alergias` text DEFAULT NULL,
  `grupo_sanguineo_id` bigint(20) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `informacion_medica` (`medical_id`, `alumno_id`, `contacto_emergencia`, `parentesco_id`, `telefono_emergencia`, `enfermedad_id`, `discapacidad_id`, `diagnostico`, `fecha_diagnostico`, `tratamiento`, `restricciones`, `alergias`, `grupo_sanguineo_id`) VALUES
(80, 2, 'buelo', 8, '04127891245', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(87, 1, 'Glen Alexander Castillo Vasquez', 6, '04129924465', 14, NULL, 'gripe y malestas', '2025-02-12', 'tomar acetaminofen', 'no debe realizar educacion fisica', '', 1),
(88, 1, NULL, 0, NULL, NULL, 8, 'miopia tipo 3', '2020-12-17', 'usar lentes en todo momento', 'no debe estar lejos de la pizarra, ni debe quitarse los lentes', '', 1),
(90, 11, 'Gustavo Georgio', 2, '02123356457', 11, NULL, 'sufre de alergia al mani', '2022-08-08', 'debe tomar antialergico si come mani', 'no comer mani de niguna manera', '', 3);
...
INSERT INTO `nacionalidades` (`id`, `codigo`, `descripcion`) VALUES
(1, 'E', 'Extranjero'),
(2, 'P', 'Pasaporte'),
(3, 'V', 'Venezolano');
...
INSERT INTO `niveles_estudio` (`id`, `nombre`, `estatus`, `orden`) VALUES
(1, 'Básica', 1, 1),
(2, 'Bachiller', 1, 2),
(3, 'Técnico Medio', 1, 3),
(4, 'Técnico Superior Universitario (TSU)', 1, 4),
(5, 'Ingeniería', 1, 5),
(6, 'Licenciatura', 1, 6),
(7, 'Postgrado', 1, 7),
(8, 'a', 0, 8),
...
CREATE TABLE `observaciones` (
  ...
  `alumno_id` int(11) DEFAULT NULL,
  `representantes_id` int(11) DEFAULT NULL,
  `profesor_id` int(11) DEFAULT NULL,
  `tipo_observacion` varchar(50) NOT NULL COMMENT 'Tipo: retiro, inhabilitacion, general, etc.',
...
INSERT INTO `observaciones` (`observacion_id`, `alumno_id`, `representantes_id`, `profesor_id`, `tipo_observacion`, `observacion`, `fecha_creacion`, `estatus`) VALUES
(1, 2, NULL, NULL, 'motivo_retiro', 'bebe wiski', '2025-12-08 12:49:58', 1),
(2, NULL, 3, NULL, 'motivo_justificativo', 'Una reunio', '2025-12-08 12:51:29', 1),
(7, NULL, 6, NULL, 'motivo_justificativo', 'Se realizo una reunion para acordar una fiesta navideña de la institucion', '2025-12-08 13:30:41', 1),
(8, NULL, NULL, 4, 'inhabilitacion', 'Inhabilitación de Profesor. Historial de Grados/Secciones: 4° - B (2025-2026), 3° - D (2026-2027). Motivo: Se fue alv', '2025-12-08 21:56:11', 1),
(9, NULL, NULL, 5, 'inhabilitacion', 'Inhabilitación de Profesor. No tenía cursos asignados.. Motivo: Profesor no hace nada xd', '2025-12-08 22:32:48', 1),
(10, NULL, NULL, 5, 'reactivacion', 'Reactivación de Profesor. Motivo: Ya ahora si trabaja xd', '2025-12-08 22:37:47', 1),
(11, 3, NULL, NULL, 'inhabilitacion', 'Inhabilitación de Alumno. No tenía inscripciones registradas.. Motivo: Los memes', '2025-12-09 00:08:10', 1),
(12, 3, NULL, NULL, 'reactivacion', 'Reactivación de Alumno. Motivo: Ya no hay memes', '2025-12-09 00:08:25', 1),
(13, 7, NULL, NULL, 'motivo_retiro', 'Retirado por salida del pais', '2025-12-10 17:47:14', 1),
(14, 7, NULL, NULL, 'motivo_retiro', 'Retirado por salida del pais', '2025-12-10 17:49:46', 1),
(15, NULL, 8, NULL, 'motivo_justificativo', 'Se realizo una reunion para acordar una fiesta navideña de la institucion', '2025-12-10 17:51:36', 1),
(16, 5, NULL, NULL, 'inhabilitacion', 'Inhabilitación de Alumno. Historial de Grados/Períodos: 3° - C (2025-2026), 4° - D (2026-2027). Motivo: Retiro de la institucion', '2025-12-10 17:54:58', 1),
(17, NULL, 1, NULL, 'inhabilitacion', 'Porque si', '2025-12-24 16:21:19', 1),
(18, NULL, 1, NULL, 'reactivacion', 'porque si x2', '2025-12-24 16:28:05', 1),
(19, 6, NULL, NULL, 'inhabilitacion', 'Inhabilitación de Alumno. No tenía inscripciones registradas.. Motivo: a', '2025-12-24 17:39:08', 1),
(20, 6, NULL, NULL, 'reactivacion', 'Reactivación de Alumno. Motivo: ae', '2025-12-24 17:39:30', 1),
(21, 6, NULL, NULL, 'inhabilitacion', 'Inhabilitación de Alumno. Historial de Grados/Períodos: 2° - A (2026-2027). Motivo: a', '2025-12-24 18:14:02', 1),
(22, NULL, NULL, NULL, 'motivo_retiro', 'a', '2025-12-24 18:14:40', 1),
(23, NULL, NULL, NULL, 'motivo_retiro', 'a', '2025-12-24 18:16:06', 1),
(24, 6, NULL, NULL, 'reactivacion', 'Reactivación de Alumno. Motivo: e', '2025-12-24 18:23:07', 1),
(25, 8, NULL, NULL, 'inhabilitacion', 'Inhabilitación de Alumno. Historial de Grados/Períodos: 3° - A (2026-2027). Motivo: a', '2025-12-24 18:28:15', 1),
(26, NULL, NULL, NULL, 'motivo_retiro', 'bebe wiski', '2025-12-24 18:41:51', 1),
(27, 4, NULL, NULL, 'inhabilitacion', 'Inhabilitación de Alumno. Historial de Grados/Períodos: 1° - A (2026-2027). Motivo: lol', '2025-12-24 18:46:34', 1),
(28, 4, NULL, NULL, 'reactivacion', 'Reactivación de Alumno. Motivo: pus nomas', '2025-12-28 12:40:17', 1),
(29, 4, NULL, NULL, 'inhabilitacion', 'Inhabilitación de Alumno. Historial de Grados/Períodos: 1° - A (2026-2027). Motivo: pus si', '2025-12-28 12:40:24', 1),
(30, NULL, NULL, 8, 'inhabilitacion', 'Inhabilitación de Profesor. No tenía cursos asignados.. Motivo: se fue alv', '2025-12-28 13:42:25', 1),
(31, NULL, NULL, 8, 'reactivacion', 'Reactivación de Profesor. Motivo: regreso alv', '2025-12-28 13:42:36', 1),
(32, NULL, 10, NULL, 'motivo_justificativo', 'a', '2025-12-28 16:14:25', 1),
(33, NULL, NULL, 1, 'inhabilitacion', 'Inhabilitación de Profesor. Historial de Grados/Secciones: 1° - A (2025-2026). Motivo: qw', '2026-01-07 22:48:53', 1),
(34, NULL, NULL, 1, 'reactivacion', 'Reactivación de Profesor. Motivo: qw', '2026-01-07 22:52:18', 1),
(35, NULL, NULL, 1, 'inhabilitacion', 'Inhabilitación de Profesor. Historial de Grados/Secciones: 1° - A (2025-2026). Motivo: qw', '2026-01-07 22:52:22', 1),
(36, NULL, NULL, 1, 'reactivacion', 'Reactivación de Profesor. Motivo: qwerty', '2026-01-07 22:53:21', 1),
(37, NULL, NULL, 1, 'inhabilitacion', 'Inhabilitación de Profesor. Historial de Grados/Secciones: 1° - A (2025-2026). Motivo: qwerty', '2026-01-07 22:53:29', 1),
(38, NULL, NULL, 9, 'inhabilitacion', 'Inhabilitación de Profesor. Historial de Grados/Secciones: 1° - A (2025-2026). Motivo: qwert', '2026-01-07 22:56:03', 1),
(39, NULL, NULL, 1, 'reactivacion', 'Reactivación de Profesor. Motivo: qwerty', '2026-01-07 23:11:18', 1),
(40, NULL, NULL, 3, 'inhabilitacion', 'Inhabilitación de Profesor. Historial de Grados/Secciones: 1° - A (2025-2026). Motivo: qwqew', '2026-01-07 23:11:59', 1),
(41, NULL, NULL, 3, 'reactivacion', 'Reactivación de Profesor. Motivo: asd', '2026-01-08 00:11:50', 1),
(42, NULL, NULL, 10, 'inhabilitacion', 'Inhabilitación de Profesor. Historial de Grados/Secciones: 1° - B (2025-2026). Motivo: ahora si lo mataron', '2026-01-08 00:23:08', 1),
(43, NULL, 4, NULL, 'reactivacion', 'Se llamaba', '2026-01-08 20:31:33', 1),
(44, NULL, NULL, 3, 'inhabilitacion', 'Inhabilitación de Profesor. Historial de Grados/Secciones: 1° - A (2025-2026). Motivo: Por que si', '2026-01-08 20:32:35', 1),
(45, NULL, NULL, 11, 'inhabilitacion', 'Inhabilitación de Profesor. Historial de Grados/Secciones: 1° - D (2025-2026), 2° - B (2026-2027). Motivo: Yayula', '2026-01-10 01:27:45', 1),
(46, NULL, 1, NULL, 'inhabilitacion', 'aaaaad', '2026-01-10 01:52:45', 1),
(47, NULL, 1, NULL, 'reactivacion', 'wwww', '2026-01-10 01:55:39', 1),
(48, 8, NULL, NULL, 'reactivacion', 'Reactivación de Alumno. Motivo: adadad', '2026-01-10 01:55:50', 1),
(49, 8, NULL, NULL, 'inhabilitacion', 'Inhabilitación de Alumno. No tenía inscripciones registradas.. Motivo: ke si', '2026-01-10 02:02:52', 1),
(50, NULL, 1, NULL, 'inhabilitacion', 'ke no', '2026-01-10 02:03:05', 1),
(51, 8, NULL, NULL, 'reactivacion', 'Reactivación de Alumno. Motivo: 12321', '2026-01-10 02:05:32', 1),
(52, NULL, 1, NULL, 'reactivacion', '31312', '2026-01-10 02:05:44', 1),
(53, 8, NULL, NULL, 'inhabilitacion', 'Inhabilitación de Alumno. No tenía inscripciones registradas.. Motivo: :V', '2026-01-10 02:09:24', 1),
(54, NULL, 1, NULL, 'inhabilitacion', 'V:', '2026-01-10 02:09:35', 1),
(55, 8, NULL, NULL, 'reactivacion', 'Reactivación de Alumno. Motivo: 1010', '2026-01-10 02:10:02', 1),
(56, NULL, 1, NULL, 'reactivacion', '1010', '2026-01-10 02:10:17', 1),
(57, NULL, 1, NULL, 'inhabilitacion', 'lñlñlñlñ', '2026-01-10 02:10:37', 1),
(58, NULL, 1, NULL, 'reactivacion', 'a', '2026-01-10 02:26:39', 1),
(59, NULL, 1, NULL, 'inhabilitacion', 'Inhabilitación de Representante.\nAlumnos representados al momento de inhabilitar:\n\nMotivo: aaaaaaaaaa', '2026-01-10 02:26:45', 1),
(60, NULL, 1, NULL, 'reactivacion', 'a', '2026-01-10 02:27:49', 1),
(61, NULL, 12, NULL, 'inhabilitacion', 'Inhabilitación de Representante.\nAlumnos representados al momento de inhabilitar:\n\nMotivo: rex', '2026-01-10 03:08:53', 1),
(62, NULL, 1, NULL, 'inhabilitacion', 'Inhabilitación de Representante.\nAlumnos representados al momento de inhabilitar:\n - Luisa Marin (CI: 5645253)\n - Baby Luigi Brother (CI: 16816459547)\n - Willian Afton (CI: 33666201) [Principal]\n\nMotivo: Listo', '2026-01-10 03:09:16', 1),
(63, 8, NULL, NULL, 'inhabilitacion', 'Inhabilitación de Alumno. No tenía inscripciones registradas.. Motivo: a', '2026-01-10 03:11:28', 1),
(64, 8, NULL, NULL, 'reactivacion', 'Reactivación de Alumno. Motivo: adad', '2026-01-10 03:13:22', 1),
(65, NULL, 12, NULL, 'reactivacion', 'daadada', '2026-01-10 03:13:34', 1),
(66, NULL, 1, NULL, 'reactivacion', 'a', '2026-01-10 03:19:01', 1),
(67, 10, NULL, NULL, 'inhabilitacion', 'Inhabilitación de Alumno. No tenía inscripciones registradas.. Motivo: ae', '2026-01-10 03:22:15', 1),
(68, NULL, 12, NULL, 'inhabilitacion', 'Inhabilitación de Representante.\nAlumnos representados al momento de inhabilitar:\n - Rigoberto Mariscal (CI: 33637673) [Principal]\n\nMotivo: ae', '2026-01-10 03:28:06', 1),
(69, NULL, 12, NULL, 'reactivacion', '131231231', '2026-01-10 03:39:22', 1),
(70, NULL, 12, NULL, 'inhabilitacion', 'Inhabilitación de Representante.\nAlumnos representados al momento de inhabilitar:\n - Rigoberto Mariscal (CI: 33637673) [Principal]\n\nMotivo: dasdadsa', '2026-01-10 03:39:39', 1),
(71, NULL, 9, NULL, 'reactivacion', 'Dsdada', '2026-01-10 03:40:51', 1),
(72, NULL, 9, NULL, 'inhabilitacion', 'Inhabilitación de Representante.\nAlumnos representados al momento de inhabilitar:\n - Kiko Chespirito (CI: 33645321) [Principal]\n\nMotivo: a', '2026-01-10 03:41:56', 1),
(73, NULL, 9, NULL, 'reactivacion', 'adasd', '2026-01-10 03:53:47', 1),
(74, NULL, NULL, 12, 'inhabilitacion', 'Inhabilitación de Profesor. No tenía cursos asignados.. Motivo: :)', '2026-01-10 17:50:16', 1),
(75, NULL, NULL, 12, 'reactivacion', 'Reactivación de Profesor. Motivo: dasdas', '2026-01-10 17:55:32', 1),
(76, NULL, 8, NULL, 'inhabilitacion', 'Inhabilitación de Representante.\nAlumnos representados al momento de inhabilitar:\n - Juanito Perez (CI: 32665987) [Principal]\n\nMotivo: Lal', '2026-01-10 18:19:02', 1),
(77, 5, NULL, NULL, 'reactivacion', 'Reactivación de Alumno. Motivo: aadada', '2026-01-10 18:19:20', 1);
...
INSERT INTO `parentesco` (`id_parentesco`, `parentesco`, `activo`) VALUES
(1, 'Abuelo(a)', 1),
(2, 'Hermano(a)', 1),
(3, 'Madre', 1),
(4, 'Padre', 1),
...
INSERT INTO `periodo_escolar` (`periodo_id`, `anio_inicio`, `anio_fin`, `estatus`) VALUES
(31, 2025, 2026, 2),
(32, 2026, 2027, 1),
(33, 2027, 2028, 2),
(34, 2028, 2029, 2);
...
--
-- Disparadores `periodo_escolar`
--
DELIMITER $$
CREATE TRIGGER `inactivar_inscripciones_periodo` AFTER UPDATE ON `periodo_escolar` FOR EACH ROW BEGIN
    -- Si el periodo cambió de activo (1) a inactivo (2)
    IF OLD.estatus = 1 AND NEW.estatus = 2 THEN
        -- Inactivar todas las inscripciones de cursos de este periodo
        UPDATE inscripcion i
        INNER JOIN curso c ON i.curso_id = c.curso_id
        SET i.estatusI = 2
        WHERE c.periodo_id = NEW.periodo_id
          AND i.estatusI = 1;
    END IF;
    
    -- Si el periodo cambió de inactivo (2) a activo (1)
    -- NO reactivamos automáticamente las inscripciones
    -- porque pueden haber sido inactivadas por otras razones
END
$$
DELIMITER ;
...
CREATE TABLE `profesor` (
  ...
  `estatus` int(11) NOT NULL DEFAULT 1,
  `director_fecha_inicio` date DEFAULT NULL,
  `director_fecha_fin` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `profesor` (`profesor_id`, `id_nacionalidades`, `cedula`, `sexo`, `nombre`, `apellido`, `id_estado`, `id_ciudad`, `id_municipio`, `id_parroquia`, `telefono`, `correo`, `es_director`, `estatus`, `director_fecha_inicio`, `director_fecha_fin`) VALUES
(1, 3, '28302596', 'F', 'Jorge', 'Hernandez', 13, 248, 189, 551, '04245557878', 'ab@cd.com', 2, 1, '2025-12-05', '2025-12-08'),
(2, 3, '28302599', 'F', 'Darlyn', 'Cabrera', 12, 225, 152, 514, '04245557878', 'ab@cd.com', 0, 1, NULL, NULL),
(3, 3, '19599456', 'F', 'Petra Maria', 'Jackson Brenda', 24, 150, 462, 1122, '04169924653', 'Ubi@hotmail.com', 0, 2, NULL, NULL),
(4, 3, '12378297', 'M', 'Glen Alexander', 'Castillo Vasquez', 24, 149, 462, 1137, '04129924465', 'Glencasti@gmail.com', 0, 1, NULL, NULL),
(5, 3, '3333333333', 'F', 'hola', 'mona', 24, 149, 462, 1138, '04225559987', 'o@gmail.com', 0, 1, NULL, NULL),
(6, 3, '8888888888', 'M', 'Arcangel', 'Pa', 14, 275, 241, 648, '02125554444', 'Lal@hotmail.com', 0, 1, NULL, NULL),
(7, 3, '9336256', 'M', 'Juan', 'Perez', 5, 80, 64, 202, '04165567894', 'Losa@gmail.com', 0, 1, NULL, NULL),
(8, 3, '24998763', 'F', 'Maxima', 'Puentes', 12, 221, 151, 502, '04145564525', 'Kagua@gmail.com', 1, 1, '2026-01-07', NULL),
(9, 3, '8548698', 'M', 'Eliel', 'Rodriguez', 24, 149, 462, 1124, '04124543269', 'Patria@gmail.com', 2, 2, '2025-12-28', '2026-01-05'),
(10, 3, '18255789', 'M', 'Tomate', 'Zon', 14, 278, 242, 652, '04127897889', 'wq@a.com', 0, 2, NULL, NULL),
(11, 3, '82073602', 'M', 'Elpan', 'Zon', 14, 278, 242, 652, '04127897889', 'wq@a.com', 0, 2, NULL, NULL),
(12, 1, '12589689', 'F', 'Lucy', 'Marielo', 24, 149, 462, 1131, '04168976545', 'Quieroamipc@gmail.com', 0, 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `profesor_niveles_estudio`
--

CREATE TABLE `profesor_niveles_estudio` (
  `id` int(11) NOT NULL,
  `profesor_id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `profesor_niveles_estudio`
--

INSERT INTO `profesor_niveles_estudio` (`id`, `profesor_id`, `especializacion_id`) VALUES
(1, 1, 4),
(2, 1, 11),
(5, 9, 1),
(6, 2, 67),
...
INSERT INTO `representantes` (`representantes_id`, `id_nacionalidades`, `cedula`, `sexo`, `nombre`, `apellido`, `id_estado`, `id_ciudad`, `id_municipio`, `id_parroquia`, `telefono`, `correo`, `estatus`) VALUES
(1, 2, '10101010', 'M', 'el crack', 'gonzalez', 13, 248, 197, 584, '01212121212', 'a@gmail.com', 1),
(2, 3, '12378297', 'M', 'Glen Alexander', 'Castillo Vasquez', 24, 149, 462, 1137, '04129924465', 'Glencasti@gmail.com', 1),
(3, 1, '816459547', 'M', 'Luigi', 'Brother', 14, 279, 241, 648, '04147654321', 'lol@gmail.com', 1),
(4, 3, '19599456', 'F', 'Petra Maria', 'Jackson Brenda', 24, 150, 462, 1122, '04169924653', 'Ubi@hotmail.com', 1),
(5, 3, '15688214', 'F', 'Deila lizzet', 'Carrillo Goncalvez', 24, 149, 462, 1137, '04224589636', 'Deila@gmail.com', 1),
(6, 3, '9875632', 'F', 'Anne Daniela', 'Petrekca Limon', 21, 510, 390, 979, '04165556272', 'Pedrito@hotmail.com', 1),
(7, 3, '27664215', 'M', 'Valentino', 'Martino', 11, 197, 132, 422, '04165597852', 'Boca@hotmail.com', 1),
(8, 3, '9336256', 'M', 'Juan', 'Perez', 5, 80, 64, 202, '04165567894', 'Losa@gmail.com', 0),
(9, 3, '4597652', 'M', 'Cantinflas', 'Chespirito', 24, 149, 462, 1127, '04163217854', 'Gato@gmai.com', 1),
(10, 3, '19456321', 'F', 'Karen', 'Mendoza', 13, 245, 190, 565, '04167771234', 'Frio@hotmail.com', 1),
(11, 3, '8956322', 'F', 'Luiza', 'Reir', 3, 47, 31, 89, '04145956237', 'Lolabunny@gmail.com', 1),
(12, 3, '5645258', 'M', 'Ortegas', 'Mariscal', 24, 149, 462, 1125, '04125556345', 'Alegria@hotmail.com', 0),
(13, 3, '21656984', 'M', 'Milei', 'Rodriguez', 24, 149, 462, 1123, '04245946377', 'Petroleolibre@hotmail.com', 1);
...
INSERT INTO `seccion` (`id_seccion`, `seccion`, `estatus`) VALUES
(1, 'A', 1),
(2, 'B', 1),
(3, 'C', 1),
(4, 'D', 1),
...
INSERT INTO `usuarios` (`user_id`, `nombre`, `usuario`, `password`, `rol`, `profesor_id`, `estatus`) VALUES
(1, 'Jorge Hernandez', 'admin', '$2y$10$kOuM89fMvkbqhfxeIBGg3.V/4as1skBjUjfbtRIlpoZG5h.cI5sC2', 1, 1, 1),
(40, 'Darlyn Cabrera', 'Asistente', '$2y$10$CB6VWGYIQU2DaFY.KJaV6eshpI6X/U.TD.gMMEqC19ID8GBHLuzFG', 2, 2, 1),
(45, 'Glen Alexander Castillo Vasquez', 'Glencasti', '$2y$10$ozsBeyN2.zYDmocOAvRx..dAjUdz7Kx.xGxwQdzco.B2v66VVBSx6', 2, 4, 2);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `vacunas_infantiles`
--

CREATE TABLE `vacunas_infantiles` (
  `id_vacuna_infantil` bigint(20) UNSIGNED NOT NULL,
  `nombre` varchar(100) NOT NULL,
  `activo` tinyint(1) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `vacunas_infantiles`
--

INSERT INTO `vacunas_infantiles` (`id_vacuna_infantil`, `nombre`, `activo`) VALUES
(1, 'BCG', 1),
(2, 'Hepatitis B', 1),
(3, 'Pentavalente Acelular', 1),
(4, 'Poliomielitis Inactivada (IPV)', 1),
(5, 'Neumococo Conjugada', 1),
(6, 'Rotavirus', 1),
(7, 'Influenza', 1),
(8, 'Triple Viral (SRP)', 1),
(9, 'DPT (Difteria, Tosferina y Tétanos)', 1),
(10, 'Varicela', 1),
(11, 'Hepatitis A', 1),
(12, 'COVID-19', 1),
(13, 'Meningococo', 1),
(14, 'Td', 0),
(15, 'VPH', 1),
(16, 'Polio inyectable (IPV)', 1),
(17, 'Fiebre Amarilla', 1),
(18, 'DTP', 1),
(19, 'Polio oral (OPV)', 1),
(20, 'DTPa', 1),
(21, 'Atun', 0),
...
ALTER TABLE `alumnos`
  ...
  ADD KEY `fk_alumnos_nacionalidades` (`id_nacionalidades`),
  ADD KEY `fk_alumnos_estado` (`id_estado`),
  ADD KEY `fk_alumnos_ciudad` (`id_ciudad`),
  ADD KEY `fk_alumnos_municipio` (`id_municipio`),
  ADD KEY `fk_alumnos_parroquia` (`id_parroquia`);

--
-- Indices de la tabla `alumnos_atencion_medica`
--
ALTER TABLE `alumnos_atencion_medica`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `alumno_representante`
  ...
  ADD UNIQUE KEY `unique_relacion` (`alumno_id`,`representante_id`),
  ADD KEY `representante_id` (`representante_id`),
  ADD KEY `fk_alumno_representante_parentesco` (`parentesco_id`);

--
-- Indices de la tabla `alumno_vacunas`
--
ALTER TABLE `alumno_vacunas`
  ADD PRIMARY KEY (`id_alumno_vacuna`),
  ADD UNIQUE KEY `unique_alumno_vacuna` (`alumno_id`,`vacuna_id`),
...
ALTER TABLE `curso`
  ...
  ADD KEY `curso_ibfk_1` (`periodo_id`),
  ADD KEY `curso_ibfk_2` (`profesor_id`),
  ADD KEY `fk_curso_turno` (`turno_id`),
  ADD KEY `fk_curso_grados` (`grados_id`),
  ADD KEY `fk_curso_seccion` (`seccion_id`),
  ADD KEY `idx_curso_periodo_grado` (`periodo_id`,`grados_id`);
...
ALTER TABLE `enfermedad`
  ADD PRIMARY KEY (`id_enfermedad_cronica`);

--
-- Indices de la tabla `especialidades_estudio`
--
ALTER TABLE `especialidades_estudio`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_especialidad_nivel` (`nivel_id`);
...
ALTER TABLE `informacion_medica`
  ...
  ADD KEY `fk_informacion_medica_parentesco` (`parentesco_id`),
  ADD KEY `fk_informacion_medica_grupo_sanguineo` (`grupo_sanguineo_id`);
...
ALTER TABLE `inscripcion`
  ...
  ADD KEY `fk_inscripcion_curso` (`curso_id`),
  ADD KEY `idx_inscripcion_alumno_periodo` (`alumno_id`,`curso_id`);
...
ALTER TABLE `observaciones`
  ...
  ADD KEY `idx_alumno_id` (`alumno_id`),
  ADD KEY `idx_tipo_observacion` (`tipo_observacion`),
  ADD KEY `idx_fecha_creacion` (`fecha_creacion`),
  ADD KEY `fk_observaciones_representante` (`representantes_id`),
  ADD KEY `fk_observaciones_profesor` (`profesor_id`),
  ADD KEY `idx_observaciones_tipo_fecha` (`tipo_observacion`,`fecha_creacion`);
...
--
-- Indices de la tabla `profesor_niveles_estudio`
--
ALTER TABLE `profesor_niveles_estudio`
  ADD PRIMARY KEY (`id`),
  ADD KEY `profesor_id` (`profesor_id`),
  ADD KEY `especializacion_id` (`especializacion_id`);

--
-- Indices de la tabla `representantes`
--
ALTER TABLE `representantes`
  ADD PRIMARY KEY (`representantes_id`);
...
--
-- Indices de la tabla `vacunas_infantiles`
--
ALTER TABLE `vacunas_infantiles`
  ADD PRIMARY KEY (`id_vacuna_infantil`);
...
--
-- AUTO_INCREMENT de la tabla `alumnos_atencion_medica`
--
ALTER TABLE `alumnos_atencion_medica`
...
--
ALTER TABLE `alumno_representante`
  MODIFY `relacion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT de la tabla `alumno_vacunas`
--
ALTER TABLE `alumno_vacunas`
  MODIFY `id_alumno_vacuna` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `curso`
  MODIFY `curso_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT de la tabla `discapacidad`
--
ALTER TABLE `discapacidad`
  MODIFY `id_discapacidad` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `enfermedad`
--
ALTER TABLE `enfermedad`
  MODIFY `id_enfermedad_cronica` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT de la tabla `especialidades_estudio`
--
ALTER TABLE `especialidades_estudio`
...
--
ALTER TABLE `grados`
  MODIFY `id_grado` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `grupo_sanguineo`
--
ALTER TABLE `grupo_sanguineo`
  MODIFY `id_grupo_sanguineo` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `informacion_medica`
--
ALTER TABLE `informacion_medica`
  MODIFY `medical_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;

--
-- AUTO_INCREMENT de la tabla `inscripcion`
--
ALTER TABLE `inscripcion`
  MODIFY `inscripcion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `observaciones`
  MODIFY `observacion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT de la tabla `parentesco`
--
ALTER TABLE `parentesco`
  MODIFY `id_parentesco` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `periodo_escolar`
  MODIFY `periodo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
-- AUTO_INCREMENT de la tabla `profesor_niveles_estudio`
--
ALTER TABLE `profesor_niveles_estudio`
...
--
ALTER TABLE `representantes`
  MODIFY `representantes_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `seccion`
  MODIFY `id_seccion` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT de la tabla `vacunas_infantiles`
--
ALTER TABLE `vacunas_infantiles`
  MODIFY `id_vacuna_infantil` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `alumnos`
  ADD CONSTRAINT `fk_alumnos_ciudad` FOREIGN KEY (`id_ciudad`) REFERENCES `ciudades` (`id_ciudad`),
  ADD CONSTRAINT `fk_alumnos_estado` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`),
  ADD CONSTRAINT `fk_alumnos_municipio` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id_municipio`),
  ADD CONSTRAINT `fk_alumnos_nacionalidades` FOREIGN KEY (`id_nacionalidades`) REFERENCES `nacionalidades` (`id`),
  ADD CONSTRAINT `fk_alumnos_parroquia` FOREIGN KEY (`id_parroquia`) REFERENCES `parroquias` (`id_parroquia`);

--
-- Filtros para la tabla `alumno_vacunas`
--
ALTER TABLE `alumno_vacunas`
  ADD CONSTRAINT `fk_alumno_vacunas_alumno` FOREIGN KEY (`alumno_id`) REFERENCES `alumnos` (`alumno_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_alumno_vacunas_vacuna` FOREIGN KEY (`vacuna_id`) REFERENCES `vacunas_infantiles` (`id_vacuna_infantil`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `especialidades_estudio`
--
ALTER TABLE `especialidades_estudio`
  ADD CONSTRAINT `fk_especialidades_nivel` FOREIGN KEY (`nivel_id`) REFERENCES `niveles_estudio` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `informacion_medica`
--
ALTER TABLE `informacion_medica`
  ADD CONSTRAINT `fk_informacion_medica_grupo_sanguineo` FOREIGN KEY (`grupo_sanguineo_id`) REFERENCES `grupo_sanguineo` (`id_grupo_sanguineo`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `inscripcion`
--
ALTER TABLE `inscripcion`
  ADD CONSTRAINT `fk_inscripcion_alumno` FOREIGN KEY (`alumno_id`) REFERENCES `alumnos` (`alumno_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_inscripcion_curso` FOREIGN KEY (`curso_id`) REFERENCES `curso` (`curso_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_inscripcion_turno` FOREIGN KEY (`turno_id`) REFERENCES `turno` (`turno_id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `municipios`
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `fk_municipios_estado` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `observaciones`
--
ALTER TABLE `observaciones`
  ADD CONSTRAINT `fk_observaciones_profesor` FOREIGN KEY (`profesor_id`) REFERENCES `profesor` (`profesor_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_observaciones_representante` FOREIGN KEY (`representantes_id`) REFERENCES `representantes` (`representantes_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `parroquias`
--
ALTER TABLE `parroquias`
  ADD CONSTRAINT `fk_parroquias_municipio` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `profesor_niveles_estudio`
--
ALTER TABLE `profesor_niveles_estudio`
  ADD CONSTRAINT `fk_profesor_niveles_especializacion` FOREIGN KEY (`especializacion_id`) REFERENCES `especialidades_estudio` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_profesor_niveles_profesor` FOREIGN KEY (`profesor_id`) REFERENCES `profesor` (`profesor_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
